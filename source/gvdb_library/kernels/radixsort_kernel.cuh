...
//!                  byte
////////////////////////////////////////////////////////////////////////////////
extern "C" __global__ void RadixSum(long long *pData, uint elements, uint elements_rounded_to_3072, uint shift)
{
...
////////////////////////////////////////////////////////////////////////////////
extern "C" __global__ void RadixPrefixSum()
{
...
//!                  byte
////////////////////////////////////////////////////////////////////////////////
extern "C" __global__ void RadixAddOffsetsAndShuffle(long long* pSrc, long long* pDst, uint elements, uint elements_rounded_to_3072, int shift)
{
  ...
  //          kvp = pSrc[pos];
        ...
        // Calculate position of radix counter to increment
        uint p = ((kvp >> shift) & RADIXMASK) * RADIXGROUPS;
